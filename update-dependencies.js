...
const ignoreDependencies = ["@fontsource/poppins","autosuggest-highlight","aws-sdk","axios","bcryptjs","bootstrap","compression","connected-react-router","cors","crypto","dompurify","dotenv","express","font-awesome","helmet","history","jsonwebtoken","mailchimp-api-v3","mailgun-js","mobile-detect","mongoose","mongoose-slug-generator","multer","node-sass","passport","passport-facebook","passport-google-oauth2","passport-jwt","rc-slider"];
